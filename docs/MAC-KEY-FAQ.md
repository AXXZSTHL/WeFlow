...
最后，如果尝试了上述所有方法依然无法解决，请记得保存完整的报错文本，特别是 SCAN_FAILED 或 HOOK_FAILED 后面跟着的英文细节。把这些信息提交到[issue](https://github.com/AXXZSTHL/WeFlow/issues/745)，会大大加快定位和修复兼容性问题的速度。
